...
const STEM_ICONS: Record<StemType, React.ReactNode> = {
  vocals: <Mic className="w-3.5 h-3.5 text-violet-400" />,
    ...
    <div className={`flex flex-col h-full bg-[#000000] border border-white/[0.08] rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] backdrop-blur-3xl overflow-hidden ${className}`}>
      ...
      <div className="h-14 px-5 bg-gradient-to-r from-[#0d0b1e]/95 via-[#100e22]/90 to-[#0d0b1e]/95 border-b border-violet-500/[0.1] flex items-center justify-between select-none shrink-0">
        ...
        <div className="flex items-center space-x-2 text-xs font-mono">
          <span className="text-[10px] text-zinc-400">Status: <span className="text-violet-300 font-bold">{processStatus.stage.toUpperCase()}</span></span>
      ...
      <div className="flex-1 p-5 grid grid-cols-1 lg:grid-cols-12 gap-5 overflow-y-auto bg-gradient-to-b from-[#000000] to-[#050508]">
        ...
        <div className="lg:col-span-8 flex flex-col gap-4">
          <div className="bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border border-white/[0.08] rounded-2xl p-5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl flex-1 flex flex-col">
            <UrlUploader
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          {/* Active Track Card */}
          <div className="bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border border-white/[0.08] rounded-2xl p-4 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl flex flex-col gap-3 select-none">
            <div className="flex items-center justify-between border-b border-white/[0.06] pb-2.5">
              ...
              {trackMetadata && (
                <button
                  ...
                  className="px-3 py-1 rounded-full bg-violet-500/10 hover:bg-cyan-500 hover:text-black text-violet-300 border border-violet-500/30 text-[10px] font-mono font-bold transition-all flex items-center space-x-1.5 active:scale-95 shadow-sm"
            ...
            {trackMetadata ? (
              <div className="flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-[10px] font-mono">
                  <div className="bg-[#08061a]/80 p-2 rounded-xl border border-white/[0.05]">
                    ...
                    {STEM_TYPES.map((stem) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <Download className="w-3.5 h-3.5 text-zinc-500 group-hover:text-violet-400 transition-colors" />
                        </a>
                      );
                    })}
                  </div>
              ...
              <div className="py-8 flex flex-col items-center justify-center text-center gap-2 text-zinc-500">
                <Music className="w-8 h-8 opacity-30 text-violet-400" />
          ...
          {songs.length > 0 && (
            <div className="bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border border-white/[0.08] rounded-2xl p-4 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl flex flex-col gap-2.5 select-none text-[10px] font-mono text-zinc-400">
              <div className="flex items-center justify-between border-b border-white/[0.06] pb-2 text-zinc-200 font-bold">
                ...
                <span className="text-[9px] text-violet-400 font-bold uppercase">Remix Active</span>
              </div>
              <div className="flex flex-col gap-1.5 max-h-[140px] overflow-y-auto pr-1">
                {songs.map((song) => (
                  <div
                    key={song.id}
                    className="p-2 rounded-xl bg-[#08061a]/80 border border-white/[0.05] flex items-center justify-between"
                  >
          ...
          <div className="bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border border-white/[0.08] rounded-2xl p-4 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl flex flex-col gap-2.5 select-none text-[10px] font-mono text-zinc-400">
            ...
            <div className="flex flex-col gap-1.5 text-[10px]">
              ...
              <div className="flex justify-between"><span className="text-zinc-500">GPU Memory:</span> <span className="text-violet-300 font-bold">{hardwareInfo?.vram_gb || 0} GB VRAM</span></div>
