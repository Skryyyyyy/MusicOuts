    ...
    <div className={`flex flex-col h-full bg-[#08090F] rounded-2xl border border-violet-500/[0.1] shadow-[0_0_0_1px_rgba(124,58,237,0.06),0_10px_40px_rgba(8,9,15,0.85)] backdrop-blur-2xl overflow-hidden ${className}`}>
      ...
      <div className="h-14 px-5 bg-gradient-to-r from-[#0d0b1e]/95 via-[#100e22]/90 to-[#0d0b1e]/95 border-b border-violet-500/[0.1] flex items-center justify-between select-none shrink-0">
        ...
        <div className="flex items-center space-x-2.5 text-xs font-mono">
          ...
          <div className="hidden xl:flex items-center space-x-1.5 px-2.5 py-1 rounded-full bg-[#08061a]/80 border border-violet-500/[0.1] shadow-inner">
            ...
            {[
              ...
              <button
                ...
                className="px-2.5 py-0.5 rounded-full text-[9px] font-extrabold bg-violet-500/[0.06] hover:bg-violet-600 hover:text-white text-violet-200/70 border border-violet-500/[0.1] hover:border-violet-400 transition-all shadow-sm active:scale-95"
          ...
          <div className="px-3 py-1.5 rounded-full bg-[#08061a]/90 border border-violet-500/[0.1] text-violet-200/50 text-[11px] flex items-center space-x-1.5">
            <Volume2 className="w-3.5 h-3.5 text-violet-400" />
            <span>Master:</span>
            <span className="text-violet-400 font-bold font-mono">{formatDb(masterVolume)}</span>
          </div>
        </div>
      </div>

      {/* Main Channel Strips Workspace */}
      <div className="flex-1 p-5 flex gap-4 overflow-x-auto items-stretch justify-center bg-gradient-to-b from-[#08090F] to-[#06050e]">
        ...
        {STEM_TYPES.map((stem) => {
          ...
          return (
            <div
              key={stem}
              className={`flex-1 min-w-[170px] max-w-[240px] bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border ${config.border} rounded-2xl flex flex-col justify-between p-4 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl relative transition-all duration-200 hover:-translate-y-0.5 ${config.glow}`}
            >
              ...
              {/* Top: Channel Header */}
              <div className="flex flex-col gap-3 border-b border-violet-500/[0.08] pb-3.5 pt-1 select-none">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-violet-500/[0.06] text-violet-300/60 border border-violet-500/[0.1] font-bold">
                    CH {config.badge}
                  </span>
                ...
                <div className="flex flex-col gap-1.5 bg-[#08061a]/70 p-2 rounded-xl border border-violet-500/[0.08]">
                  ...
                  <input
                    ...
                    className="w-full h-1.5 bg-violet-500/[0.1] rounded-full appearance-none cursor-pointer accent-violet-400"
                  />
                </div>
                  ...
                  <button
                    ...
                    className={`py-1.5 rounded-xl text-xs font-mono font-extrabold tracking-wider border transition-all active:scale-95 ${
                      state.muted
                        ...
                        : "bg-violet-500/[0.04] text-violet-200/40 border-violet-500/[0.08] hover:text-violet-100 hover:bg-violet-500/[0.1]"
                    }`}
                  >
                    MUTE
                  </button>
              ...
              <div className="flex-1 flex items-center justify-center gap-4 py-5 select-none">
                ...
                <div className="w-4 h-full min-h-[190px] bg-[#06040f] rounded-full border border-violet-500/[0.1] p-1 flex flex-col-reverse justify-start overflow-hidden relative shadow-inner">
                  <div
              ...
              <div className="border-t border-violet-500/[0.08] pt-3 flex flex-col items-center gap-1 select-none">
                <span className="text-xs font-mono font-extrabold text-violet-100 px-2.5 py-0.5 rounded-full bg-violet-500/[0.06] border border-violet-500/[0.1]">
        ...
        <div className="w-[210px] bg-gradient-to-b from-[#130f2a]/95 to-[#0f0c22]/95 border-2 border-violet-500/50 rounded-2xl flex flex-col justify-between p-4 shadow-[0_10px_40px_rgba(124,58,237,0.25)] backdrop-blur-2xl relative transition-all">
          {/* Top Master Glow Line */}
          <div className="absolute top-0 left-6 right-6 h-[3px] bg-violet-400 rounded-b-full shadow-[0_0_12px_rgba(139,92,246,0.9)]" />

          <div className="flex flex-col gap-3 border-b border-violet-500/[0.08] pb-3.5 pt-1 select-none">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono px-2.5 py-0.5 rounded-full bg-violet-500/15 text-violet-300 border border-violet-500/30 font-extrabold">
                MAIN BUSS
              </span>
            ...
            {onDjFilterChange && (
              <div className="bg-[#08061a]/80 p-2.5 rounded-xl border border-violet-500/[0.1] flex flex-col gap-2">
                ...
                <div className="flex gap-1.5 pt-0.5">
                  <button
                    ...
                    className={`flex-1 py-1 text-[9px] font-mono font-bold rounded-lg transition-all active:scale-95 ${
                      djFilterType === "lowpass" ? "bg-violet-600 text-white shadow-[0_0_10px_rgba(124,58,237,0.5)]" : "bg-white/[0.04] text-zinc-400 border border-white/[0.06]"
                    }`}
                  >
                    LOWPASS
                  </button>
          ...
          <div className="flex-1 flex items-center justify-center gap-4 py-5 select-none">
            <div className="flex gap-1.5 h-full min-h-[190px]">
              <div className="w-3.5 h-full bg-[#06040f] rounded-full border border-violet-500/[0.1] p-0.5 flex flex-col-reverse justify-start overflow-hidden relative shadow-inner">
                <div
                  className="w-full rounded-full transition-all duration-75"
                  style={{
                    height: `${masterVu}%`,
          ...
          <div className="border-t border-violet-500/[0.08] pt-3 flex flex-col items-center gap-1 select-none">
            <span className="text-xs font-mono font-extrabold text-violet-300 px-2.5 py-0.5 rounded-full bg-violet-500/10 border border-violet-500/20">
