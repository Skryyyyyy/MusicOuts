...
export const GestureLabView: React.FC<GestureLabViewProps> = ({
  ...
  return (
    <div className={`flex flex-col h-full bg-[#08090F] rounded-2xl border border-violet-500/[0.1] shadow-[0_0_0_1px_rgba(124,58,237,0.06),0_10px_40px_rgba(8,9,15,0.85)] backdrop-blur-2xl overflow-hidden ${className}`}>
        ...
        <div className="flex items-center space-x-3 text-xs font-mono">
          <button
            ...
            className={`px-4 py-1.5 rounded-full text-xs font-bold border transition-all flex items-center space-x-2 shadow-sm active:scale-95 ${
              isGestureEnabled
                ? "bg-violet-500/20 border-violet-500/50 text-violet-300 shadow-[0_0_15px_rgba(124,58,237,0.45)]"
      ...
      <div className="flex-1 p-5 grid grid-cols-1 lg:grid-cols-12 gap-5 overflow-y-auto bg-gradient-to-b from-[#08090F] to-[#06050e]">
        {/* Left: Interactive Camera & Skeleton View (7 Cols) */}
        <div className="lg:col-span-7 flex flex-col gap-3 min-h-[420px]">
          <div className="flex-1 bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border border-white/[0.08] rounded-2xl p-4 flex flex-col shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl overflow-hidden">
        ...
        <div className="lg:col-span-5 flex flex-col gap-4">
          ...
          <div className="bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border border-white/[0.08] rounded-2xl p-4 flex flex-col gap-3.5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl select-none">
            ...
            <div className="bg-[#0b0c12]/70 p-3 rounded-xl border border-white/[0.05] flex flex-col gap-2.5">
              ...
              <div className="w-full h-2.5 bg-[#08090c] rounded-full overflow-hidden p-0.5 border border-white/[0.06]">
                <div
                  className="h-full bg-violet-400 rounded-full transition-all duration-100 shadow-[0_0_10px_rgba(0,229,255,0.8)]"
            ...
            <div className="bg-[#0b0c12]/70 p-3 rounded-xl border border-white/[0.05] flex flex-col gap-2.5">
              ...
              <div className="bg-[#08061a]/90 p-2 rounded-lg border border-white/[0.06] flex items-center justify-between text-[10px] font-mono">
          ...
          <div className="bg-gradient-to-b from-[#0d0b1e]/90 to-[#0a0818]/90 border border-white/[0.08] rounded-2xl p-4 flex flex-col gap-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-xl select-none">
            ...
            <div className="flex flex-col gap-2.5 text-[10px] font-mono text-zinc-400">
              <div className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 rounded-full bg-violet-400 mt-1.5 shadow-[0_0_6px_rgba(0,229,255,0.8)]" />
                <div>
